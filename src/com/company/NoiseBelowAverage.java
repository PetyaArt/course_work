...
public class NoiseBelowAverage extends  JFrame{
    ...
    public static void main(String[] args) throws IOException {
        File mFileImage = new File("src//com//company//image//NoiseBelowAverage.png");
        ...
        new com.company.NoiseBelowAverage().setVisible(true);
    }

    public NoiseBelowAverage() {
